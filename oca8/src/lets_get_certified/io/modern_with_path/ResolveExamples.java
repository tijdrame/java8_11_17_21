...
public class ResolveExamples {
    public static void main(String[] args) {
        Path absolute = Paths.get("C:\\Users\\tidiane\\OneDrive - Alithya\\Documents\\cours\\java\\oca8");
        Path relative = Path.of("nio2");
        Path file     = Path.of("name.txt");
        
        System.out.println("absolute.resolve(relative): "+ 
                absolute.resolve(relative));// C:\Users\tidiane\OneDrive - Alithya\Documents\cours\java\oca8\nio2
