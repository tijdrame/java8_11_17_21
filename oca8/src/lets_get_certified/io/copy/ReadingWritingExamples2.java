package lets_get_certified.io.copy;
...
//      copyTextFile(true);
 ...
 //       copyBinaryFile(true);
    ...
    public static void copyTextFile(boolean buffering){
        //
        File src = new File ("C:\\\\Users\\\\tidiane\\OneDrive - Alithya\\\\Documents\\\\cours\\\\java\\\\oca8\\\\src\\\\lets_get_certified\\\\io\\\\ReadingWritingExamples.java");
        File dest = new File ("C:\\\\Users\\\\tidiane\\OneDrive - Alithya\\\\Documents\\\\cours\\\\java\\\\oca8\\\\src\\\\lets_get_certified\\\\io\\\\copy\\ReadingWritingExamples2.java");
    ...
    public static void copyBinaryFile(boolean buffering){
        ...
        File src = new File ("./out/production/oca8/lets_get_certified/io/ReadingWritingExamples.class");
        File dest = new File ("./out/production/oca8/lets_get_certified/io/ReadingWritingExamples2.class");
